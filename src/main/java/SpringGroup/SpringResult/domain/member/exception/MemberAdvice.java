...
@RestControllerAdvice(basePackages = "SpringGroup.SpringResult.domain.member.controller")
public class MemberAdvice {
  ...
  public ResponseEntity<Response> handleMemberException(MemberException exception) throws JsonProcessingException {
